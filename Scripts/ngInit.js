    ...
    return {
        ...
        , link: function (scope, element) {
            scope.$watch("barCode", function (newValue) {
                element.html("");
                if (newValue) {
                    var sTemplate = '<embed width="100%" height="800px"  runat="server"  name="embedPDF" id="embedPDF" src="/service/fetchPDFSearch?imageName=' + newValue + '&scrollbar=0" type="application/pdf" internalinstanceid="8" />'
